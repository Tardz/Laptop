files_last_update=$(jq -r '.date' "$HOME/scripts/rofi/automation/desktop_version/save_files_data.json")
files_prev_update=$(jq -r '.old_date' "$HOME/scripts/rofi/automation/desktop_version/save_files_data.json")
...
"  Bisync to Desktop [$files_last_update] | $HOME/scripts/rofi/automation/desktop_version/bisync_files.sh"
"  Sync from Laptop | $HOME/scripts/rofi/automation/desktop_version/laptop_sync_files.sh"
"  Bisync to Laptop | $HOME/scripts/rofi/automation/desktop_version/laptop_bisync_files.sh"
"  Revert [$files_prev_update] | $HOME/scripts/rofi/automation/desktop_version/revert_files.sh"
)