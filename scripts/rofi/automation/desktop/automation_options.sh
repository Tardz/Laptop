files_last_update=$(jq -r '.date' "$HOME/scripts/rofi/automation/desktop/save_files_data.json")
files_prev_update=$(jq -r '.old_date' "$HOME/scripts/rofi/automation/desktop/save_files_data.json")
