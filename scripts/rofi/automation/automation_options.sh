...
"Floating - Add | $HOME/scripts/qtile/update_floating.sh"
"Floating - Remove | $HOME/scripts/qtile/remove_floating.sh"
"Group Match - Add | $HOME/scripts/qtile/update_group_match.sh"
"Group Match - Remove | $HOME/scripts/qtile/remove_group_match.sh"
