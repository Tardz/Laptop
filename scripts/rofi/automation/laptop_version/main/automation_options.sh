files_last_update=$(jq -r '.date' "$HOME/scripts/rofi/automation/laptop_version/save_files_data.json")
files_prev_update=$(jq -r '.old_date' "$HOME/scripts/rofi/automation/laptop_version/save_files_data.json")
...
"  Sync from Laptop | $HOME/scripts/rofi/automation/laptop_version/sync_files.sh"
"  Bisync to Laptop | $HOME/scripts/rofi/automation/laptop_version/bisync_files.sh"
