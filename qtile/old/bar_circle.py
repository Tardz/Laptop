...
from unicodes import right_arrow, left_arrow, upper_left_triangle, upper_right_triangle, left_half_circle, right_half_circle
...
bar = Bar([
    ...
    left_half_circle(gruvbox['arrow2'], gruvbox['systray']),
